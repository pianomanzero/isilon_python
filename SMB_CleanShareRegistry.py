...
#this is a script to provide a workaround to Bugs: 106040; 110235
#where there exists an order of operations issue in PAPI.
#manifests as not being able to see SMB shares in WebGUI 

# Install Instructions
# cd /ifs/data/Isilon_Support
# drop onto share, copy into /ifs/data/Isilon_Support
#add execute bit (chmod +x)
#
#Running the script: 
